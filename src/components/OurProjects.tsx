        ...
        <div className="relative mb-20 overflow-hidden rounded-xl shadow-2xl bg-white">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/5 p-8 lg:p-12 flex flex-col justify-center">
              ...
              <Link 
                to={`/projetos/${projects[activeProject - 1].id}`}
          ...
          <div className="absolute bottom-0 left-0 right-0 flex">
            {projects.map((project) => (
              <button
                ...
                className={`flex-1 py-3 text-center uppercase text-xs tracking-wider font-semibold transition-colors ${
                  activeProject === project.id 
                    ? "bg-primary text-white" 
                    : "bg-white/80 text-dark/60 hover:bg-gray-100"
                }`}
              >
                Projeto {project.id}
              </button>

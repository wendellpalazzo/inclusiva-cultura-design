    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-earth mb-4">Quem Somos</h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
          <p className="text-lg text-dark/80 max-w-3xl mx-auto">
            Somos uma organização comprometida com a inclusão e valorização da cultura surda, 
            trabalhando para construir pontes entre comunidades através da educação e da arte.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="bg-earth/5 p-6 rounded-lg border-l-4 border-primary">
              <h3 className="text-xl font-bold text-earth mb-3">Nossa Missão</h3>
              <p className="text-dark/80">
                Promover a inclusão social das pessoas surdas através da difusão da Língua Brasileira 
                de Sinais (Libras) e da cultura surda, criando oportunidades de desenvolvimento pessoal e profissional.
              </p>
            </div>
            ...
            <div className="bg-earth/5 p-6 rounded-lg border-l-4 border-secondary">
              ...
              <p className="text-dark/80">
                Ser referência nacional na promoção da acessibilidade e inclusão das pessoas surdas, 
                contribuindo para uma sociedade mais justa e igualitária.
              </p>
            </div>
            
            <div className="bg-earth/5 p-6 rounded-lg border-l-4 border-earth">
              <h3 className="text-xl font-bold text-earth mb-3">Nossos Valores</h3>
              <p className="text-dark/80">
                Inclusão, respeito à diversidade, excelência, inovação, cooperação e compromisso social.
              </p>
            </div>
          </div>
        ...
        <div className="mt-20">
          <h3 className="text-2xl font-bold text-earth text-center mb-10">Nossa Equipe</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105">
                ...
                />
                <div className="p-6">
                  <h4 className="text-xl font-bold text-earth">{member.name}</h4>
